        ...
        <div className="w-full">
            <div className="bg-[#F6F6F699] w-full p-6 rounded-lg flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="text-white bg-primary-500 text-base font-medium py-3 px-6 rounded-full">
                        Buy Now
                    </button>
                </div>
            </div>
                ...
                <div className="w-2/3 flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    {/* Qunatity Increment */}
                                    <div className="flex gap-1 items-center">
                                        <div className="p-2 bg-grey-50 rounded-sm h-10 w-10 text-center text-base text-grey-950 font-medium cursor-pointer">
                                            -
                                        </div>
                                        <div className="p-2 bg-grey-50 rounded-sm h-10 w-10 text-center text-base text-grey-950 font-medium cursor-pointer">
                                            1
                    ...
                    <div className="bg-[#FCFCFC] rounded-lg py-5 px-4 flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="py-4 px-3 border-b border-b-grey-100 rounded-lg">
                                <p className="text-grey-700 text-base font-normal">Lorem ipsum dolor sit amet consectetur. Amet tempor id suspendisse id sed nibh felis ullamcorper in. Quis sit urna ornare id mattis praesent purus diam pretium.</p>
                            </div>
                            <div className="py-4 px-3 border-b border-b-grey-100 rounded-lg">
                                <p className="text-grey-700 text-base font-normal">Quam lobortis ultrices amet ipsum sem pharetra</p>
                            </div>
                ...
                <div className="bg-[#F6F6F6] rounded-lg w-1/3 h-[702px] py-5 px-5">
                    ...
                    <div className="flex items-center justify-between py-5">
                        <div className="gap-4 items-center flex">
                            <div className="bg-grey-600 h-14 w-14 rounded-sm">
