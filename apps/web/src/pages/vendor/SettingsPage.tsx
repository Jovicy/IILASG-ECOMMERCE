        ...
        <TabsContent value="profile">
          <div className="flex flex-col gap-8">
              ...
              {[
                ...
                <div key={i} className="w-[49%] flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-full bg-white border border-grey-100 py-2 px-3 text-sm"
                  />
                </div>
              ))}
            ...
            <div className="flex justify-end">
              <button className="bg-yellow-500 text-white py-3 px-6 rounded-full text-base font-normal">
                Save Changes
              </button>
            </div>
          </div>
                ...
                <div key={day} className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-6">
                    <input
                      ...
                      className="bg-white border border-grey-200 rounded-xl p-2 text-sm w-24"
                    />
                    <p>to</p>
                    <input
                      type="time"
                  ...
                  >
                    <div
                      className={`bg-white w-6 h-6 rounded-full shadow-md transform transition-transform duration-300 ${workingHours[i].enabled ? "translate-x-6" : "translate-x-0"
                        }`}
                    ></div>
                  </div>
                </div>
            ...
            <div className="flex flex-col gap-3">
              {shippingOptions.map((option, i) => (
                <div key={i} className="p-6 bg-[#F6F6F6] rounded-lg flex gap-6 items-center">
                  ...
                  >
                    <div
                      className={`bg-white w-6 h-6 rounded-full shadow-md transform transition-transform duration-300 ${option.enabled ? "translate-x-6" : "translate-x-0"
                        }`}
                    ></div>
                  </div>
            ...
            {(() => {
              ...
              const renderStatusButton = () => {
                switch (verificationStatus) {
                  case "not_verified":
                    return (
                      <button className="py-3 px-6 bg-error-50 border border-error-600 rounded-full text-error-600 font-normal text-base">
                        Not Verified
                      </button>
                    );
                  case "in_progress":
                  ...
                  <div className="flex flex-col gap-2 w-[318px] relative">
                    ...
                    <div className="relative">
                      ...
                      <div
                        ...
                        className="bg-white border border-grey-100 rounded-full py-2 px-3 text-gray-700 cursor-pointer flex justify-between items-center"
                      >
                      ...
                      {isOpen && (
                        <div
                          className="absolute top-[44px] left-0 w-full bg-white border border-grey-100 rounded-lg shadow-md z-10 overflow-y-auto"
          ...
          <div className="flex flex-col gap-8">
            <div className="bg-[#F6F6F6] py-5 px-4 rounded-lg flex flex-col gap-6">
              <div className="flex flex-col gap-1">
                ...
                <textarea placeholder="We accept returns within 7 days of delivery. Items must be in original condition with tags attached. Refunds will be processed within 3-5 business days." className="bg-white border border-grey-100 py-2 px-3 rounded-2xl h-[77px]"></textarea>
              </div>
            </div>
            <div className="flex items-center justify-end">
              <button className="bg-primary-500 py-3 px-6 rounded-full text-white text-base font-normal cursor-pointer">
