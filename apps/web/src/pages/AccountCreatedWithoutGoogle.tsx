    ...
    <div className="h-auto flex justify-center py-16">
      <div className="flex flex-col items-center gap-16 relative">
        ...
        <div className="flex flex-col gap-1 w-xl text-center">
          ...
          <p className="text-grey-500 font-normal text-lg">Welcome aboard! Just one more step, let’s complete your profile to tailor your experience.</p>
        </div>
        ...
        <div className="w-[666px] bg-grey-50 flex flex-col gap-12 py-8 px-12 rounded-2xl">
          ...
          <div className="flex flex-col gap-8">
            <p className="text-grey-900 text-base font-normal">Indigenous Lagosians earn extra points and badges. Confirm your status to unlock special benefits.</p>
          ...
          <div className="flex items-center justify-end">
            <button
              ...
              className={`flex items-center gap-2 py-3 px-6 rounded-full text-base font-normal transition ${
                isStepFilled ? "bg-primary-500 text-white hover:bg-primary-600" : "bg-grey-100 text-grey-300 cursor-not-allowed"
              }`}>
